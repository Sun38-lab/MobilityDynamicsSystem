...
単に実機を動かしてパラメータを調整するのではなく、Pythonによるプラントモデルの構築とシミュレーション、C#を用いた自作ツールによるデータドリブンなシステム同定を実施し、ハードウェア制約を含めた実用的な制御環境の構築を行っています。
...
図3から、連続的な目標値変化に対しても安定して追従していることが分かります。<br/>
